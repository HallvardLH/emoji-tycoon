...
export const bigEmojiUpgrades: UpgradeType[] = [
    ...
    },
    {
        ...
        icon: "🤚",
        description: "The sound of the tapping is now an immensely loud, rhytmic thump that sends a shockwave in its radius.",
        tierPosition: 13,
        id: 213,
    },
    {
    ...
    },
    {
        ...
        icon: "💀",
        description: "The fallen angel himself crawls up from his dominious in order to help you tap your screen.",
        tierPosition: 23,
        id: 223,
    },
    {
